...
public class College extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!isInternetPresent) {
            ...
            alert.showAlertDialog(College.this, "Internet Connection Error",
        ...
        if (gps.canGetLocation()) {
            ...
            alert.showAlertDialog(College.this, "GPS Status",
    ...
    class LoadPlaces extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(College
                    .this);
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                //
                String types = "college"; // Listing places only cafes, restaurants
                Log.d("types: ",types);
                ...
                Toast.makeText(College.this,"nearPlaces: "+nearPlaces,Toast.LENGTH_LONG).show();
                ...
                public void run() {
                    ...
                    if("OK".equals(status)){
                        ...
                        if (nearPlaces.results != null) {
                            ...
                            // list adapter
                            ListAdapter adapter = new SimpleAdapter(College.this, placesListItems,
                                    R.layout.list_item,
                        ...
                        // Zero results found
                        alert.showAlertDialog(College.this, "Near Places",
                                "Sorry no places found. Try to change the types of places",
                                false);
                    }
                    else if("UNKNOWN_ERROR".equals(status))
                    {
                        alert.showAlertDialog(College.this, "Places Error",
