...
public class NextActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!isInternetPresent) {
            ...
            alert.showAlertDialog(NextActivity.this, "Internet Connection Error",
        ...
        if (gps.canGetLocation()) {
            ...
            alert.showAlertDialog(NextActivity.this, "GPS Status",
    ...
    class LoadPlaces extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                //
                String types = "hotels"; // Listing places only cafes, restaurants
                Log.d("types: ",types);
                ...
                Toast.makeText(NextActivity.this,"nearPlaces: "+nearPlaces,Toast.LENGTH_LONG).show();
                ...
                public void run() {
                    ...
                    if("OK".equals(status)){
                        ...
                        if (nearPlaces.results != null) {
                            ...
                            // list adapter
                            ListAdapter adapter = new SimpleAdapter(NextActivity.this, placesListItems,
                                    R.layout.list_item,
                        ...
                        // Zero results found
                        alert.showAlertDialog(NextActivity.this, "Near Places",
                                "Sorry no places found. Try to change the types of places",
                                false);
                    }
                    else if("UNKNOWN_ERROR".equals(status))
                    {
                        alert.showAlertDialog(NextActivity.this, "Places Error",
