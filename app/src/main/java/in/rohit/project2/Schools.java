...
public class Schools extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!isInternetPresent) {
            ...
            alert.showAlertDialog(Schools.this, "Internet Connection Error",
        ...
        if (gps.canGetLocation()) {
            ...
            alert.showAlertDialog(Schools.this, "GPS Status",
    ...
    class LoadPlaces extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Schools
                    .this);
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                //
                String types = "school"; // Listing places only cafes, restaurants
                Log.d("types: ",types);
                ...
                Toast.makeText(Schools.this,"nearPlaces: "+nearPlaces,Toast.LENGTH_LONG).show();
                ...
                public void run() {
                    ...
                    if("OK".equals(status)){
                        ...
                        if (nearPlaces.results != null) {
                            ...
                            // list adapter
                            ListAdapter adapter = new SimpleAdapter(Schools.this, placesListItems,
                                    R.layout.list_item,
                        ...
                        // Zero results found
                        alert.showAlertDialog(Schools.this, "Near Places",
                                "Sorry no places found. Try to change the types of places",
                                false);
                    }
                    else if("UNKNOWN_ERROR".equals(status))
                    {
                        alert.showAlertDialog(Schools.this, "Places Error",
