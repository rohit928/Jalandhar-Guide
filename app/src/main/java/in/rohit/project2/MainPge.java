...
import in.kaur.project2.MainActivity;
import in.kaur.project2.R;
import yweathergetter4a.WeatherInfo;
import yweathergetter4a.YahooWeatherExceptionListener;
import yweathergetter4a.WeatherInfo.ForecastInfo;
import yweathergetter4a.YahooWeather;
import yweathergetter4a.YahooWeather.SEARCH_MODE;
import yweathergetter4a.YahooWeather.UNIT;
...
public class MainPge extends Activity implements YahooWeatherInfoListener,
...
//				                   "high temperature in ºF: " + forecastInfo.getForecastTempHighF() + "\n"
    ...
    private void searchByPlaceName(String location) {
        ...
        mYahooWeather.queryYahooWeatherByPlaceName(getApplicationContext(), location, MainPge.this);
    }
    ...
    private void showProgressDialog() {
        ...
        mProgressDialog = new ProgressDialog(MainPge.this);
        mProgressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        mProgressDialog.show();
    }
