    ...
    class LoadPlaces extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                //
                String types = "cafe|restaurant|school|hospital|atm|bank"; // Listing places only cafes, restaurants
                Log.d("types: ",types);
                ...
                Toast.makeText(MapsActivity.this,"nearPlaces: "+nearPlaces,Toast.LENGTH_LONG).show();
